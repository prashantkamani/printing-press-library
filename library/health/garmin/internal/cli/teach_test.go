...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/health/garmin/internal/cliutil/testenv"
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"garmin-pp-cli auth login",
		"garmin-pp-cli doctor",
		"garmin-pp-cli help items",
		"garmin-pp-cli sync",
		"garmin-pp-cli profile list",
		"garmin-pp-cli feedback list",
		"garmin-pp-cli which",
		"garmin-pp-cli agent-context",
		"garmin-pp-cli completion bash",
		"garmin-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"garmin-pp-cli teach",
		"garmin-pp-cli recall",
		"garmin-pp-cli learnings",
		"garmin-pp-cli teach-pattern",
		"garmin-pp-cli teach-lookup",
		"garmin-pp-cli items list",
	}
