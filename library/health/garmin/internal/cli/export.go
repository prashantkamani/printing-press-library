...
large datasets as it has no memory pressure.`,
  ...
  garmin-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  garmin-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  garmin-pp-cli export <resource> --format jsonl | jq '.id'`,
