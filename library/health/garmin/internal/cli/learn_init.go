...
import (
	...
	"github.com/mvanhorn/printing-press-library/library/health/garmin/internal/learn/entities"
...
func runLearnInitOnce(ctx context.Context) {
	learnInitOnce.Do(func() {
		...
		if err != nil {
			fmt.Fprintf(os.Stderr, "warning: garmin-pp-cli: learn init: open store: %v\n", err)
			return
		}
		defer s.Close()
		if err := initLearn(ctx, s.DB()); err != nil {
			fmt.Fprintf(os.Stderr, "warning: garmin-pp-cli: learn init: %v\n", err)
		}
	})
}
...
func learnResourceTypeFields() map[string][]string {
	return map[string][]string{
		"account":                   {"displayName", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"activities":                {"activityId", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"activity_service_activity": {"activityId", "name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"activity_service_activity_hr_time_in_zones": {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"activity_service_activity_splits":           {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"fitness":                                    {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"heart_rate":                                 {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"heart_rate-heart-rate-zones":                {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"sleep":                                      {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"steps":                                      {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"training":                                   {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
		"wellness":                                   {"name", "title", "display_name", "full_name", "short_name", "label", "slug", "key", "code", "id", "address"},
	}
}
