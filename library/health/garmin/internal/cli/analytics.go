...
Null or missing --group-by values are JSON null. Table output labels them (none); a literal (none) value is quoted.`,
  ...
  garmin-pp-cli analytics --type messages

  # Group by a field
  garmin-pp-cli analytics --type messages --group-by author_id

  # Top 10 most frequent values
  garmin-pp-cli analytics --type messages --group-by channel_id --limit 10 --json`,
